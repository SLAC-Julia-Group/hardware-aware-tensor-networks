"""
Unified operator for compression and identity layers.
...
class UnifiedCascadableOperator(CascadableOperator):
    """
    Unified operator that automatically handles compression and identity.
    ...
    def _determine_operation_type(self) -> str:
        """Determine if this is compression or identity."""
    ...
    def __repr__(self):
        ...
        type_str = {"compression": "↓", "identity": "="}[self.operation_type]
